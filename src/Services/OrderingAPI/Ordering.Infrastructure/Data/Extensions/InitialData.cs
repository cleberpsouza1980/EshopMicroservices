...
public class InitialData
{
    ...
    public static IEnumerable<Product> Products =>
        new List<Product>
        {
            ...
            Product.Create(ProductId.Of(new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914")),"Sansung 10",450),
            Product.Create(ProductId.Of(new Guid("4f136e9f-ff8c-4c1f-9a33-d12f689bdab8")),"Huawei Plus",600),
